document.addEventListener("DOMContentLoaded", function () {
  ...
  document
    .getElementById("sort-az")
    .addEventListener("click", () => sortStudentsByFullName("asc"));
  document
    .getElementById("sort-za")
    .addEventListener("click", () => sortStudentsByFullName("desc"));
  document
    .getElementById("sort-marks")
    .addEventListener("click", sortStudentsByMarks);
  document
    .getElementById("sort-passing")
    .addEventListener("click", sortStudentsByPassing);
  document
    .getElementById("sort-class")
    .addEventListener("click", sortStudentsByClass);
  document
    .getElementById("sort-gender")
    .addEventListener("click", sortStudentsByGender);
